#!/bin/bash
# Chemeleon2-mode RL Training (2 GPU) — portable, no Slurm
# Usage: bash scripts/run_rl_dapo_chemeleon2_2gpu.sh
set -euo pipefail
...
OUTPUT="results/train/h_cgqe_rl_chemeleon2_2gpu.pt"
